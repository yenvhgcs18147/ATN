      ...
      <main>
        <div class="row" style="background-color: #FBEFF5;">
          <div class="col" style="margin: 20px 100px">
            <div class="items">
              <img class="home" src="Image/Cooking/1.jpg">
              <h3>Set Cute Kitchen</h3>
              <p class="price">US$10.00</p>
            </div>
            <div class="items">
              <img class="home" src="Image/Cooking/2.jpg">
              <h3>Japenese Style Wooden Kitchen</h3>
              <p class="price">US$13.00</p>
            </div>
            <div class="items">
              <img class="home" src="Image/Cooking/3.jpg">
              <h3>Super-else Mini kitchen</h3>
              <p class="price">US$13.00</p>
            </div>
          </div>
        </div>
