      ...
      <main>
        <div class="row" style="background-color: #FBEFF5;">
          <div class="col" style="margin: 20px 100px">
            <div class="items">
              <img class="home" src="Image/Doll/1.jpg">
              <h3>Letter Graphic Top</h3>
              <p class="price">US$4.00</p>
            </div>
            <div class="items">
              <img class="home" src="Image/Doll/2.jpg">
              <h3>Letter Graphic Top</h3>
              <p class="price">US$10.00</p>
            </div>
            <div class="items">
              <img class="home" src="../Image/Doll/3.jpg">
              <h3>Letter Graphic Top</h3>
              <p class="price">US$13.00</p>
            </div>
            <div class="items">
              <img class="home" src="Image/Doll/4.jpg">
              <h3>Letter Graphic Top</h3>
              <p class="price">US$11.00</p>
            </div>
